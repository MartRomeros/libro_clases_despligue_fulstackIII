...
# Script para crear y configurar la instancia Bastion en AWS Academy
# Este script cumple con las especificaciones de usar Ubuntu, instalar psql y poblar la base de datos.
...
echo "🔑 Extrayendo credenciales de terraform.tfvars..."
...
echo "☁️ Lanzando instancia EC2 (Ubuntu)..."
...
echo "🗄️ Poblando la base de datos RDS..."
ssh -i vockey -o StrictHostKeyChecking=no ubuntu@$PUBLIC_IP << EOF
